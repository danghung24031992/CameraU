...
export default {
    ...
    // Footer
    footerHeight: 55,
    footerDefaultBg: (Platform.OS === 'ios' ) ? '#FFFFFF' : '#FFFFFF',


    //FooterTab
    tabBarTextColor: (Platform.OS === 'ios' ) ? '#58595b' : '#58595b',
    tabBarActiveTextColor: (Platform.OS === 'ios' ) ? '#2ab354' : '#2ab354',
    tabActiveBgColor: (Platform.OS=='ios') ? '#FFFFFF' : '#FFFFFF',
    ...
    listDividerBg: '#ddd',
    listItemHeight: 10,
    listItemPadding: (Platform.OS === 'ios' ) ? 10 : 10,
